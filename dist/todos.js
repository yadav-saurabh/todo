...
export default class Todos {
    constructor() {
        ...
        this.createTodo = (obj) => {
            ...
            btnWrapper.append(this.createElement('button', [{ type: "id", handler: 'edit' + obj.id }], [{ type: 'onclick', handler: 'editTodo' }]), this.createElement('button', [{ type: "id", handler: 'delete' + obj.id }], [{ type: 'onclick', handler: 'deleteTodo' }]));
            ...
            wrapper.append(this.createElement('h3', [{ type: 'id', handler: 'todo-head' + obj.id }, { type: "innerHTML", handler: obj.head }]), this.createElement('span', [{ type: "id", handler: 'todo-text' + obj.id }, { type: "innerHTML", handler: obj.text }]));
        ...
        this.changeTodoStatus = e => {
            ...
            if (nodeName === "SPAN" || nodeName === "H3" || (nodeName === "INPUT" && type === "checkbox")) {
                ...
                const chkbox = document.getElementById("checkbox" + id);
                const todoData = common.getTodos();
